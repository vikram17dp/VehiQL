    ...
    <div className="pt-20 flex flex-col">
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center px-4">
          <div className="mb-8">
            <h1 className="gradient-title from-blue-500 to-green-500 mb-6">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Button className={"flex items-center"} varient="ghost" asChild>
              <Link href="/cars">
                View All
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 hover:shadow-md transition cursor-pointer">
            {carMakes.map((make) => {
              return (
                <Link
                  key={make.name}
