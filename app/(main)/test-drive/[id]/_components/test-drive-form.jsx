...
import useFetch from "@/hooks/use-fetch";import { format, parseISO } from "date-fns";
...
useEffect(() => {
  if (bookingResult?.success) {
    ...
    setBookingDetails({
      ...
      timeSlot: `${format(
        parseISO(`${dateStr}T${bookingResult.data.startTime}`),
        "h:mm a"
      )} - ${format(
        parseISO(`${dateStr}T${bookingResult.data.endTime}`),
        "h:mm a"
      )}`,
